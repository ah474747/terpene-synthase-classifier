"""
Validation script for terpene synthase product prediction.
This script implements comprehensive validation methods to test the system.
"""
...
class TerpeneSynthaseValidator:
    """
    Comprehensive validation class for terpene synthase product prediction.
    """
    ...
    def run_comprehensive_validation(self, 
                                   uniprot_limit: int = 200,
                                   ncbi_limit: int = 200) -> Dict[str, any]:
        """
...
def main():
    ...
    validator = TerpeneSynthaseValidator(email="your_email@example.com")
    
    # Run comprehensive validation
    results = validator.run_comprehensive_validation(uniprot_limit=100, ncbi_limit=100)
